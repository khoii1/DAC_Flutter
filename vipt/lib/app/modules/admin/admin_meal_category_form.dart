...
class AdminMealCategoryForm extends StatefulWidget {
  final Category? category;

  const AdminMealCategoryForm({Key? key, this.category}) : super(key: key);

  @override
  State<AdminMealCategoryForm> createState() => _AdminMealCategoryFormState();
}

class _AdminMealCategoryFormState extends State<AdminMealCategoryForm> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _assetController = TextEditingController();
  final _provider = MealCategoryProvider();
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_selectedImageFile != null) {
        ...
        throw Exception('Vui lòng chọn ảnh cho danh mục món ăn');
      }
